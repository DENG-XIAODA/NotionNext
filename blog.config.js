...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Moqio', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '天下皆白，唯我独黑', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.moqio.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2114832690@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '湘ICP备2022023726号-1', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      ...
      cover:
            'http://p2.music.126.net/LwisuwyurwWs3zpkoBIC9g==/19024849695642179.jpg'
    }
  ],
